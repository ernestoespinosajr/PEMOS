...
export const metadata: Metadata = {
  title: 'PEMOS - Sistema de Monitoreo Electoral',
  description:
    'Sistema de monitoreo politico y electoral para la gestion organizacional y el seguimiento de procesos electorales.',
};
